menuController = function()
{
    ...
    {
        var html_item  = '<div class="box element" id="item_'+item.id+'" data-weight="'+item.weight+'" data-size="'+item.size+'" data-price="'+item.price+'" data-title="'+item.title.replace(/"/g, "")+'">'+
