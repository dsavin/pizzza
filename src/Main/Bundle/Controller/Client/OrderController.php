    ...
    public function sendItemsAction(Request $request)
    {
        ...
        if ($request->isXmlHttpRequest()) {
          ...
          foreach($data['items'] as $k => $item) {
            ...
            mail($chain->getEmail(), 'Заказ с Pizzza.com.ua для ' . $chain->getName(), $message, $headers);
            mail('info@pizzza.com.ua', '[ДУБЛИКАТ] Заказ с Pizzza.com.ua для' . $chain->getName(), $message, $headers);
